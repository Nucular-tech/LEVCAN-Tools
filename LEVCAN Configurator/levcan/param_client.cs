    ...
    public class LCPC_Entry : IDisposable
    {
        ...
        public unsafe object Variable
        {
            get
            {
                ...
                else if (EType == LCP_EntryType.Bitfield32 || EType == LCP_EntryType.Enum || EType == LCP_EntryType.Bool || EType == LCP_EntryType.Uint32 || EType == LCP_EntryType.Uint64)
                {
                    switch (VariableSize)
                    {
                        case 1:
            ...
            set
            {
                ...
                else if (EType == LCP_EntryType.Bitfield32 || EType == LCP_EntryType.Enum || EType == LCP_EntryType.Bool || EType == LCP_EntryType.Uint32 || EType == LCP_EntryType.Uint64)
                {
                    ...
                    {
                        case 1:
                            *(byte*)VariablePtr = (byte)(uint)value;
                            break;
                        case 2:
                            *(ushort*)VariablePtr = (ushort)(uint)value;
                            break;
                        case 4:
                            *(uint*)VariablePtr = (uint)value;
                            break;
                        case 8:
                            *(ulong*)VariablePtr = (ulong)value;
                            break;
