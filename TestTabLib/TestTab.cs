...
namespace TestTabLibrary
{
    ...
    [Export(typeof(LEVCAN_ConfiguratorTabI))]
    public class TestTab : LEVCAN_ConfiguratorTabI
    {
        LevcanHandler Lev;
        ...
        public bool Draw()
        {
            if (ImGui.BeginTabItem($"CanTestTab {requestcntr}###testab"))
            {
